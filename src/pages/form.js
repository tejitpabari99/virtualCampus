...
function getText(key, val) {
    ...
    if (val !== undefined && val !== "")
        return key + ": " + val;
    return key + ": user did not provide";
}
...
function uploadData(data) {
    ...
    emailData['text'] = "New Event Request!\n" +
                        emailData['text'].concat('\nClick here to approve this event: ',
...
class AddEvent extends React.Component {
    ...
    submitHandler(values) {
        if (values['file'] !== '' && values['file'] !== undefined) {
            ...
            const b = uploadData(values)

            this.setState({ feedbackSubmit: true })
            if (b) {
                this.setState({message: "Success! We have received your request!"})
            } else {
                this.setState({message: "Oops... Sorry! There was an error handling your request."})
            }
        }
    }
    closeModal() {
        this.setState({ feedbackSubmit: false });
    ...
    render()
    {
        return (
            <div>
                <Popup
                    open={this.state.feedbackSubmit}
                ...
                >
                    <div style={{
                        ...
                        color: '#0072CE',
                        margin: '10px'}}>
                        <a style={{color: 'black', paddingLeft: '95%', cursor: 'pointer'}} onClick={this.closeModal}>
                            &times;
                        </a>
                        <br />
                        <div style={{fontSize: '32px'}}> {this.state.message} </div>
                        <br />
                        Thank you for submitting a request to add an event!
                            ...
                            <GridContainer spacing={10}>
                                <GridItem xs={4}>
                                    ...
                                    <div style={{
                                        ...
                                        Thank you for your interest in leading a virtual event or activity through
                                        CVC.
                                            ...
                                            return (
                                                <Form>
                                                    <div style={{margin: '15px 0'}}>
                                                        ...
                                                        <GridContainer>
                                                            <GridItem sm={6}>
                                                                <FormikField label="Name / Organization" name="name"
                                                                             error={errors.name}
                                                                             touch={touched.name}
                                                    ...
                                                    <div style={{margin: '15px 0'}}>
                                                        ...
                                                        <GridContainer>
                                                            <GridItem>
                                                                <FormikField label="Event Description" name="desc"
                                                                             multiline rows="5" error={errors.desc}
                                                        ...
                                                        <div style={{paddingTop: "18px"}}>
                                                            Please provide AT LEAST ONE of the following links for
                                                            your
                                                            event.
                                                        </div>
                                                        <GridContainer spacing={3}>
                                                            <GridItem sm={6}>
                                                                <FormikField label="Website / Event Link"
                                                                             ...
                                                                             touch={touched.event_link} required/>
                                                            </GridItem>
                                                            <GridItem sm={6}>
                                                                <FormikField
